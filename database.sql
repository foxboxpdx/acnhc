...
CREATE TABLE IF NOT EXISTS "fish" (
  "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, 
  "name" VARCHAR(256) NOT NULL, 
  "modifiers" VARCHAR(6) DEFAULT '000000' NOT NULL,
  "months" VARCHAR(12) DEFAULT '000000000000' NOT NULL, 
  "hours" VARCHAR(24) DEFAULT '000000000000000000000000' NOT NULL, 
  "sellprice" INTEGER DEFAULT 0 NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "bugs" (
  "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, 
  "name" VARCHAR(256) NOT NULL, 
  "modifiers" VARCHAR(4) DEFAULT '0000' NOT NULL,
